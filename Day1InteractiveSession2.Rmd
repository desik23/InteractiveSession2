...
Now let's estimate the population over that range of times, given the capacity = 2580, initial population - 230, rate = 0.32


```{r}
chipmunk_pop <- pop_logistic(capacity= 2800, time_yr = time_vec, init_pop = 230, rate = 0.32)
```
...
ggplot(data = chipmunk_df, aes(x = time_vec, y = chipmunk_pop)) + 
  ...
  labs(x= "Time (years)",
       ...
       title = "Chipmunk Population over Time",
       subtitle = "Plot")
